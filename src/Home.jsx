...
const Home = () => {
  ...
  return (
    <div className='bg-white'>
      ...
      {/* Hero Section */}
      <header className='relative h-[100vh] lg:h-[100vh] flex items-center text-white overflow-hidden'>
          ...
          <div className='max-w-4xl'>
            <div className='inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-8 animate-fade-in-up'>
              ...
              <span className='text-sm font-medium text-gray-200'>
                Trusted by {stats.industrialPartners} industrial partners
                worldwide
              </span>
            ...
            <h1 className='text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-fade-in-up animation-delay-200'>
              ...
              <span className='relative'>
                ...
                <span className='relative inline-block ml-2'>
                  <span
                    className='bg-gradient-to-r from-primary via-primaryDark to-primary bg-clip-text text-transparent'
                    style={{
                  ...
                  <span
                    className='absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r rounded-full animate-slide-in'
                    style={{
            ...
            <p className='text-lg md:text-xl text-gray-300 max-w-2xl mb-8 animate-fade-in-up animation-delay-400 leading-relaxed'>
              At Trojan Trading, we take pride in our extensive experience and
              in-depth industry knowledge in the supply of high-quality domestic
              and industrial gas equipment, as well as gas water heaters, to the
              construction industry, gas installers, and plumbing companies.
            </p>
            ...
            <div className='flex flex-wrap gap-4 mb-10 animate-fade-in-up animation-delay-600'>
              ...
              <span className='flex items-center gap-2 bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10'>
                <i
                  ...
                  style={{ color: colors.secondary }}></i>
                <span className='text-sm'>Medical</span>
              </span>
              <span className='flex items-center gap-2 bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10'>
                <i
                  className='fa-solid fa-flask'
                  style={{ color: colors.primaryDark }}></i>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {features.map((feature) => (
              <div
                key={feature.id}
                className='group relative bg-white/80 rounded-xl p-5 border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1'>
            ...
            {industries.map((industry) => (
              <Link
                ...
                <div className='relative aspect-square rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all'>
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-t opacity-80 group-hover:opacity-90 transition-opacity`}
                    style={{
                      backgroundImage: `linear-gradient(to top, ${colors.secondaryDark}, ${colors.primaryDark})`,
                    }}></div>
                  <div className='absolute inset-0 p-3 flex flex-col justify-end text-white'>
                    <h3 className='text-sm font-bold mb-1'>{industry.name}</h3>
                    <div className='text-xs mb-2 bg-white/20 backdrop-blur-sm px-2 py-0.5 rounded-full inline-block w-fit'>
                      {industry.clients}
                    </div>
                  </div>
                </div>
      ...
      <section
        ...
        <div className='absolute inset-0 opacity-20'>
          <div
            className='absolute top-0 -left-4 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl animate-blob'
          ...
          <div className='flex flex-col lg:flex-row items-center gap-12'>
            <div className='lg:w-1/2 space-y-6'>
              ...
              <h3 className='text-4xl md:text-5xl font-bold'>
                <span
                  ...
                  style={{
                    backgroundImage: `linear-gradient(to right, ${colors.primary}, ${colors.primaryDark}, ${colors.primary})`,
                  }}>
              ...
              <p className='text-lg text-gray-300 leading-relaxed max-w-lg'>
                Fully integrated with Trojan Forge. Manage your inventory,
                warehouse, workshop, invoicing, and accounting from one powerful
                software suite.
              </p>
              ...
              <div className='flex flex-wrap gap-3 pt-2'>
                <span className='flex items-center gap-2 bg-white/5 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10'>
                  <i
                    className='fa-solid fa-box text-xs'
                    style={{ color: colors.primary }}></i>
                  <span className='text-xs text-gray-300'>Inventory</span>
                </span>
                <span className='flex items-center gap-2 bg-white/5 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10'>
                  <i
                    className='fa-solid fa-warehouse text-xs'
                    style={{ color: colors.primary }}></i>
                  <span className='text-xs text-gray-300'>Warehouse</span>
                </span>
                <span className='flex items-center gap-2 bg-white/5 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10'>
                  <i
                    className='fa-solid fa-file-invoice text-xs'
                    style={{ color: colors.primary }}></i>
                  <span className='text-xs text-gray-300'>Invoicing</span>
                </span>
                <span className='flex items-center gap-2 bg-white/5 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10'>
                  <i
                    className='fa-solid fa-calculator text-xs'
                    style={{ color: colors.primary }}></i>
            ...
            <div className='lg:w-1/2'>
              <div className='relative group'>
                <div
                  className='absolute -inset-1 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition'
                  style={{
                    backgroundImage: `linear-gradient(to right, ${colors.primary}, ${colors.secondary})`,
                  }}></div>
                <div
                  className='relative bg-gradient-to-br p-1 rounded-2xl shadow-2xl border border-white/10'
                  style={{ backgroundColor: colors.secondaryDark }}>
                  <div
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: `linear-gradient(to right, ${colors.primary}33, ${colors.secondary}33)`,
                      }}>
